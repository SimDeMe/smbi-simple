...
const tasks = [
    {
        title: 'Byg maltose',
        predict: {
            q: 'Gæt først: to glukoser bindes sammen. Hvad sker der med vand?',
            options: ['Der optages ét vandmolekyle',
                      'Der fraspaltes ét vandmolekyle',
    ...
    },
    {
        ...
        predict: {
            q: 'Gæt først: hvor mange monomerer skal der mindst til i én kæde for at danne 4 vandmolekyler?',
            options: ['4', '5', '8'],
            correct: 1
        },
    ...
    },
    {
        ...
        predict: {
            ...
            options: ['Nej — samme sumformel betyder samme stof',
                      'Ja — bindingerne kan sidde forskelligt'],
            correct: 1
        },
    ...
    },
    {
        ...
        predict: {
            ...
            options: ['Flere frie ender, så mange enzymer kan arbejde samtidig',
                      'En stærkere kæde, der er sværere at klippe',
    ...
    },
    {
        ...
        predict: {
            ...
            options: ['En allergi over for mælk',
                      'Et enzym der mangler',
                      'For meget syre i maven'],
            correct: 1
        },
